 ...
 */
definition(
    name: "VDM Child - Switch",
    namespace: "bkeifer/VDMChildSwitch",
...
def devicePage() {
    dynamicPage(name: "devicePage", title: "New Virtual Switch", install: true, uninstall: childCreated()) {
        if (!childCreated()) {
...
def namePage() {
    dynamicPage(name: "namePage", title: "New Virtual Switch", install: false, uninstall: childCreated()) {
        section {
